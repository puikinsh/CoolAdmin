                ...
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="fontawesome-list-wrap">
                            <section id="new">
                                <h2 class="title-2 fontawesome-list__title">11 New Icons in 4.0</h2>
                            ...
                            <section id="web-application">
                                <h2 class="title-2 fontawesome-list__title">Web Application Icons</h2>
                            ...
                            <section id="form-control">
                                <h2 class="title-2 fontawesome-list__title">Form Control Icons</h2>
                            ...
                            <section id="currency">
                                <h2 class="title-2 fontawesome-list__title">Currency Icons</h2>
                            ...
                            <section id="text-editor">
                                <h2 class="title-2 fontawesome-list__title">Text Editor Icons</h2>
                            ...
                            <section id="directional">
                                <h2 class="title-2 fontawesome-list__title">Directional Icons</h2>
                            ...
                            <section id="video-player">
                                <h2 class="title-2 fontawesome-list__title">Video Player Icons</h2>
                            ...
                            <section id="brand">
                                <h2 class="title-2 fontawesome-list__title">Brand Icons</h2>

                                <div class="alert alert-success">
                                    <ul class="margin-bottom-none padding-left-lg">
                                        <li>All brand icons are trademarks of their respective owners.</li>
                                        <li>The use of these trademarks does not indicate endorsement of the trademark holder
                                            by Font Awesome, nor vice versa.</li>
                                    </ul>
